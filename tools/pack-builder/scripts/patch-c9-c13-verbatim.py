#!/usr/bin/env python3
"""Append C9–C13 story cards with verbatim PDF English and vocabulary marks."""
...
from story_lesson_translations_c9_c13 import TRANSLATIONS  # noqa: E402
...
LESSON_META: dict[str, dict] = {
    'C9': {
        'sortOrder': 9,
        'titleEn': 'The Spring of Youth',
        'titleZh': '青年之春',
    },
    'C10': {
        'sortOrder': 10,
        'titleEn': 'Peter and the Wolf',
        'titleZh': '彼得和狼',
    },
    'C11': {
        'sortOrder': 11,
