#!/usr/bin/env python3
"""Append C14–C18 story cards with verbatim PDF English and vocabulary marks."""
...
from story_lesson_translations_c14_c18 import TRANSLATIONS  # noqa: E402
...
LESSON_META: dict[str, dict] = {
    ...
    'C17': {
        'sortOrder': 17,
        'titleEn': 'Cupid, the Bad Boy',
        'titleZh': '坏孩子丘比特',
    },
    'C18': {
        'sortOrder': 18,
        'titleEn': 'How the Rabbit Loses Her Tail',
        'titleZh': '兔子是怎么失去尾巴的',
    },
}
