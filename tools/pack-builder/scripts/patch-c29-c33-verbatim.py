#!/usr/bin/env python3
"""Append C29–C33 story cards with verbatim PDF English and vocabulary marks."""
...
from story_lesson_translations_c29_c33 import TRANSLATIONS  # noqa: E402
...
LESSON_META: dict[str, dict] = {
    ...
    'C31': {
        'sortOrder': 31,
        'titleEn': "The Son Who Doesn't Listen",
        'titleZh': '不听话的儿子',
    },
    'C32': {
        'sortOrder': 32,
        'titleEn': 'How the Tiger Gets His Stripes',
        'titleZh': '虎纹是怎么来的',
    },
    'C33': {
        'sortOrder': 33,
        'titleEn': 'Why the Sea Has Salt',
        'titleZh': '为什么海里有盐',
    },
}
