#!/usr/bin/env python3
"""Append C34–C38 story cards with verbatim PDF English and vocabulary marks."""
...
from story_lesson_translations_c34_c38 import TRANSLATIONS  # noqa: E402
...
LESSON_META: dict[str, dict] = {
    'C34': {
        'sortOrder': 34,
        'titleEn': 'The Four Dragons',
        'titleZh': '四条龙',
    },
    'C35': {
        'sortOrder': 35,
        'titleEn': 'The Green Monkey',
        'titleZh': '绿色的猴子',
    },
    'C36': {
        'sortOrder': 36,
        'titleEn': 'The Rat Catcherw',
        'titleZh': '捉鼠记',
    },
    'C37': {
        'sortOrder': 37,
        'titleEn': 'The Language of the Birds',
        'titleZh': '鸟的语言',
    },
    'C38': {
        'sortOrder': 38,
