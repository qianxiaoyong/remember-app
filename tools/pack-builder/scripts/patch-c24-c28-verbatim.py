#!/usr/bin/env python3
"""Append C24–C28 story cards with verbatim PDF English and vocabulary marks."""
...
from story_lesson_translations_c24_c28 import TRANSLATIONS  # noqa: E402
...
LESSON_META: dict[str, dict] = {
    ...
    'C26': {
        'sortOrder': 26,
        'titleEn': 'The Mice and the Cat',
        'titleZh': '老鼠和猫',
    },
    'C27': {
        'sortOrder': 27,
        'titleEn': 'The Sleeping Spell',
        'titleZh': '睡眠法术',
    },
    'C28': {
        'sortOrder': 28,
