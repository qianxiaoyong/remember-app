#!/usr/bin/env python3
"""Append C19–C23 story cards with verbatim PDF English and vocabulary marks."""
...
from story_lesson_translations_c19_c23 import TRANSLATIONS  # noqa: E402
...
LESSON_META: dict[str, dict] = {
    'C19': {
        'sortOrder': 19,
        'titleEn': 'The King with the Golden Touch',
        'titleZh': '点石成金的国王',
    },
    'C20': {
        'sortOrder': 20,
        'titleEn': 'The Rabbit and His Ears',
        'titleZh': '兔子和他的耳朵',
    },
    'C21': {
        'sortOrder': 21,
    ...
    'C22': {
        'sortOrder': 22,
        'titleEn': 'The Wolf and the Seven Children',
        'titleZh': '狼和七个孩子',
    },
    'C23': {
        'sortOrder': 23,
        'titleEn': 'The Heart of a Monkey',
        'titleZh': '猴子的心脏',
    },
}
