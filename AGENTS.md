...
- 总开发顺序：`docs/superpowers/plans/2026-07-26-remember-app-mvp-development-order.md`。
- 成熟架构选型证据：`docs/research/2026-07-26-mature-architecture-audit.md`。
- 当前用户要求与架构、安全或数据规则冲突时，明确报告冲突并等待确认，不得静默绕过。
- 更深目录中的规则可以补充本文件，但不能削弱根规则。
